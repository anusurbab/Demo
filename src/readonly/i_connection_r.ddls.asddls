@AbapCatalog.sqlViewName: 'ICONNECT_R'
...
define view I_Connection_R
  as select from connection as Connection

  association [1..*] to I_Flight_R as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to I_Carrier  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: 'I_Airport',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
