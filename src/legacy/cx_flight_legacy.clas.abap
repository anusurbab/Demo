CLASS cx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'CM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'CM_FLIGHT_LEGAC',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE travel_id OPTIONAL
        booking_id            TYPE booking_id OPTIONAL
        booking_supplement_id TYPE booking_supplement_id OPTIONAL
        agency_id             TYPE agency_id OPTIONAL
        customer_id           TYPE customer_id OPTIONAL
        carrier_id            TYPE carrier-carrier_id OPTIONAL
        connection_id         TYPE connection-connection_id OPTIONAL
        supplement_id         TYPE supplement-supplement_id OPTIONAL
        begin_date            TYPE begin_date OPTIONAL
        end_date              TYPE end_date OPTIONAL
        booking_date          TYPE booking_date OPTIONAL
        flight_date           TYPE flight_date OPTIONAL
        status                TYPE travel_status OPTIONAL
        currency_code         TYPE currency_code OPTIONAL
        uname                 TYPE syuname OPTIONAL.


    DATA: mv_travel_id             TYPE travel_id,
          mv_booking_id            TYPE booking_id,
          mv_booking_supplement_id TYPE booking_supplement_id,
          mv_agency_id             TYPE agency_id,
          mv_customer_id           TYPE customer_id,
          mv_carrier_id            TYPE carrier-carrier_id,
          mv_connection_id         TYPE connection-connection_id,
          mv_supplement_id         TYPE supplement-supplement_id,
          mv_begin_date            TYPE begin_date,
          mv_end_date              TYPE end_date,
          mv_booking_date          TYPE booking_date,
          mv_flight_date           TYPE flight_date,
          mv_status                TYPE travel_status,
          mv_currency_code         TYPE currency_code,
...
CLASS cx_flight_legacy IMPLEMENTATION.
