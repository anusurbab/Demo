CLASS /dmo/cl_flight_amdp DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency IMPORTING VALUE(iv_amount)               TYPE total_price
                                                  VALUE(iv_currency_code_source) TYPE currency_code
                                                  VALUE(iv_currency_code_target) TYPE currency_code
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE total_price.
ENDCLASS.



CLASS cl_flight_amdp IMPLEMENTATION.
